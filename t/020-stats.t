#!/usr/bin/env escript
%% -*- erlang -*-
%%! -pa ./ebin -boot start_sasl -config heman -sasl errlog_type error
...
main(_) ->
    ...
    (fun() ->
        ...
        etap:is(heman:get(<<"movies">>, <<"comedy">>), 2, "getting value of rule 2"),
        ok
    end)(),
    ...
    (fun() ->
        ...
        etap:is(heman:get(<<"movies">>, <<"drama">>), 5, "getting value of rule 3"),
        ok
    end)(),
    ...
    (fun() ->
        ...
        etap:is(heman:get(<<"movies">>, <<"crime">>), 5, "getting value of rule 4"),
        ok
    end)(),
    ...
    (fun() ->
        ...
        etap:is(heman:get(<<"movies">>, <<"documentary">>), 3, "getting value of rule 5"),
        ok
    end)(),
    ...
    (fun() ->
        ...
        etap:is(heman:get(<<"movies">>, <<"western">>), 7, "getting value of rule 6"),
        ok
    end)(),
    ...
    (fun() ->
        ...
        etap:is(heman:get(<<"movies">>, <<"horror">>), 6, "getting value of rule 7"),
        ok
    end)(),
    ...
    (fun() ->
        ...
        etap:is(heman:get(<<"movies">>, <<"animation">>), 5, "getting value of rule 8"),
        ok
    end)(),
